...
class WheelOfDragonPage extends React.Component {

    render() {
        return (
            <Layout>
                <>
                    <h1 className="display-none">Wheel of Dragon</h1>
                </>
...
const hoc = (injectIntl(WheelOfDragonPage));

export default hoc;

export const Head = () => (
    <SeoHead
        title="Wheel of Dragon"
