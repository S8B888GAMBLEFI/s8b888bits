...
class RevenueDividendSharePage extends React.Component {

    render() {
        return (
            <Layout>
                <>
                    <h1 className="display-none">Revenue Dividend Share</h1>
                </>
...
const hoc = (injectIntl(RevenueDividendSharePage));

export default hoc;

export const Head = () => (
    <SeoHead
        title="Revenue Dividend Share"
        ...
        ogTitle="Revenue Dividend Share"
